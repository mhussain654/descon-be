  ...
  module Otp
    class VerifyService < ApplicationService
      ...
      def call
        ...
        challenge = candidate && latest_challenge_for(candidate)

        unless candidate && challenge
      ...
      def evaluate(candidate:, challenge:)
        ...
        if challenge.match?(@code)
          succeed(candidate:, challenge:)
        else
